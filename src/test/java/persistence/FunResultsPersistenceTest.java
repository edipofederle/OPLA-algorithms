...
//        
//        String query = "insert into objectives (id, execution_id, objectives, is_all, experiement_id, solution_name) values ("+ funs.get(0).getId()+","+funs.get(0).getExecution().getId()+",'"+funs.get(0).getObjectives()+"',"+funs.get(0).getIsAll()+","+funs.get(0).getExperiement().getId()+")";
