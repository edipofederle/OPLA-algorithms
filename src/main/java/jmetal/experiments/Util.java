...
public class Util {
	...
	public static void copyFolder(String experimentId, String executionId)
			throws IOException {
	...
	public static void moveAllFilesToExecutionDirectory(String experiementID,
			String executionID) {
		String exts[] = { "uml", "di", "notation" };

		@SuppressWarnings("unchecked")
		List<File> listFiles = (List<File>) FileUtils.listFiles(new File(
				ReaderConfig.getDirExportTarget()), exts, false);
